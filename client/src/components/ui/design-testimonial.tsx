...
export function Testimonial() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background overflow-hidden py-20">
      <div ref={containerRef} className="relative w-full max-w-5xl px-4" onMouseMove={handleMouseMove}>
        ...
        <div className="relative flex flex-col md:flex-row">
          ...
          <div className="flex flex-col items-center justify-center pr-0 md:pr-16 md:border-r border-border mb-8 md:mb-0">
            <motion.span
              className="text-xs font-mono text-muted-foreground tracking-widest uppercase hidden md:block"
            ...
            <div className="relative h-32 w-px bg-border mt-8 hidden md:block">
              <motion.div
          ...
          >
            {[...Array(10)].map((_, i) => (
              <span key={i} className="mx-8">
                Nosso Pediatra • Gastropediatra • Uberaba •
              </span>
            ))}
          </motion.div>
        </div>
