...
export const initialQuestions: Question[] = [
  {
    ...
    options: ["Refluxo ou vômitos", "Intestino preso / constipação", "Dor de barriga", "Suspeita de reação a alimentos", "Ainda não sei ao certo"],
    nextQuestions: {
      "Refluxo ou vômitos": "reflux-frequency",
      "Intestino preso / constipação": "constipation-frequency",
      "Dor de barriga": "belly-pain-type",
      "Suspeita de reação a alimentos": "allergy-symptoms",
      "Ainda não sei ao certo": "age-check",
    },
  },
];
